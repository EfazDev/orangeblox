...
"""
Orange API 🍊 | Made by Efaz from efaz.dev | v2.4.6a
\n
...
# Variables
current_version = {"version": "2.4.6a", "bootstrap_version": "2.4.6a"}
requested_functions = {}
cached_information = {}
colors_class = Colors()
translators = None
...
class OrangeAPI:
    ...
    **However, the API will no longer be supported by OrangeBlox in v2.4.0+ (in which mod scripts will automatically transform to OrangeAPI)**
    ...
    def getOrangeBloxName(self) -> str | None:
        ...
        **This function is only available in OrangeAPI v2.4.6a+**
