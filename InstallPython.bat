...
if "%arch%"=="AMD64" (
    set "url=https://www.python.org/ftp/python/3.14.6/python-3.14.6-amd64.exe"
) else if "%arch%"=="ARM64" (
    set "url=https://www.python.org/ftp/python/3.14.6/python-3.14.6-arm64.exe"
) else (
    set "url=https://www.python.org/ftp/python/3.14.6/python-3.14.6.exe"
)
