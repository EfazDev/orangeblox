...
if "%arch%"=="AMD64" (
    set "url=https://www.python.org/ftp/python/3.14.0/python-3.14.0-amd64.exe"
) else if "%arch%"=="ARM64" (
    set "url=https://www.python.org/ftp/python/3.14.0/python-3.14.0-arm64.exe"
) else (
    set "url=https://www.python.org/ftp/python/3.14.0/python-3.14.0.exe"
)
