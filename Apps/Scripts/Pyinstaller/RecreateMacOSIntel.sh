...
pyinstaller ./Apps/Scripts/Pyinstaller/OrangeBlox_macOSIntel.spec --clean --distpath Apps/Building --noconfirm
...
cd "./Apps/Building"
zip -r -y ../OrangeBloxMacIntel.zip "OrangeBlox.app"
cd "../Storage"
zip -r -y ../OrangeBloxMacIntel.zip "OrangePlayRoblox.app" "OrangeLoader.app" "OrangeRunStudio.app"
cd ../../
