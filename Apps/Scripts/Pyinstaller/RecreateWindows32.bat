...
if exist Apps\PlayRoblox.exe (
    move /Y Apps\PlayRoblox.exe OrangeBloxWindows\x86\PlayRoblox.exe
)
if exist Apps\RunStudio.exe (
    move /Y Apps\RunStudio.exe OrangeBloxWindows\x86\RunStudio.exe
)
...
if exist Apps\OrangeBlox (
    ...
    if exist Apps\OrangeBlox\PlayRoblox.exe (
        move /Y Apps\OrangeBlox\PlayRoblox.exe OrangeBloxWindows\x86\PlayRoblox.exe
    )
    if exist Apps\OrangeBlox\RunStudio.exe (
        move /Y Apps\OrangeBlox\RunStudio.exe OrangeBloxWindows\x86\RunStudio.exe
    )
