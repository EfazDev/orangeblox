...
if exist Apps\PlayRoblox.exe (
    move /Y Apps\PlayRoblox.exe OrangeBloxWindows\x64\PlayRoblox.exe
)
if exist Apps\RunStudio.exe (
    move /Y Apps\RunStudio.exe OrangeBloxWindows\x64\RunStudio.exe
)
...
if exist Apps\OrangeBlox (
    ...
    if exist Apps\OrangeBlox\PlayRoblox.exe (
        move /Y Apps\OrangeBlox\PlayRoblox.exe OrangeBloxWindows\x64\PlayRoblox.exe
    )
    if exist Apps\OrangeBlox\RunStudio.exe (
        move /Y Apps\OrangeBlox\RunStudio.exe OrangeBloxWindows\x64\RunStudio.exe
    )
...
if "%1"=="signexe" (
    ...
    if exist OrangeBloxWindows\x64\PlayRoblox.exe (
        signtool sign /a /fd SHA256 /tr http://timestamp.digicert.com /td SHA256 "OrangeBloxWindows\x64\PlayRoblox.exe"
    )
    if exist OrangeBloxWindows\x64\RunStudio.exe (
        signtool sign /a /fd SHA256 /tr http://timestamp.digicert.com /td SHA256 "OrangeBloxWindows\x64\RunStudio.exe"
    )
)
