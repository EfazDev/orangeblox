...
clang++ -framework Cocoa -std=c++17 -arch x86_64 -g -o "./Apps/OrangeBloxLoad.app/Contents/MacOS/OrangeBloxLoad" ./Apps/Scripts/Clang/OrangeBloxLoad.mm -g0

printMessage "Building Clang Package for OrangePlayRoblox.."
clang++ -framework Cocoa -std=c++17 -arch x86_64 -g -o "./Apps/Play Roblox.app/Contents/MacOS/OrangePlayRoblox" ./Apps/Scripts/Clang/OrangePlayRoblox.mm -g0

printMessage "Building Clang Package for OrangeRunStudio.."
clang++ -framework Cocoa -std=c++17 -arch x86_64 -g -o "./Apps/Run Studio.app/Contents/MacOS/OrangeRunStudio" ./Apps/Scripts/Clang/OrangeRunStudio.mm -g0
