...
clang++ -framework Cocoa -framework Foundation -std=c++17 -arch x86_64 -g -o "./Apps/EfazRobloxBootstrapLoad.app/Contents/MacOS/EfazRobloxBootstrapLoad" ./Apps/Scripts/Clang/EfazRobloxBootstrapLoad.cpp -g0

printMessage "Building Clang Package for EfazRobloxBootstrapPlayRoblox.."
clang++ -framework Cocoa -framework Foundation -std=c++17 -arch x86_64 -g -o "./Apps/Play Roblox.app/Contents/MacOS/EfazRobloxBootstrapPlayRoblox" ./Apps/Scripts/Clang/EfazRobloxBootstrapPlayRoblox.cpp -g0
