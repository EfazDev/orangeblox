...
clang++ -std=c++17 -arch x86_64 -g -o "./Apps/Play Roblox.app/Contents/MacOS/OrangePlayRoblox" ./Apps/Scripts/Clang/OrangePlayRoblox.cpp -g0

printMessage "Building Clang Package for OrangeRunStudio.."
clang++ -std=c++17 -arch x86_64 -g -o "./Apps/Run Studio.app/Contents/MacOS/OrangeRunStudio" ./Apps/Scripts/Clang/OrangeRunStudio.cpp -g0
