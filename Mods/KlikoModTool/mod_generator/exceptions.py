...
class FileExtractError(ModGeneratorError):
    pass

class FileRestoreError(ModGeneratorError):
    pass

class FileDownloadError(ModGeneratorError):
    pass

class FileCompressError(ModGeneratorError):
    pass